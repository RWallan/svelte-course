...
export const POST: RequestHandler = async ({ request }) => {
	...
	// As MVP, it will be hard coded for now
	...
	const bookArray = [
		...
		{ bookTitle: 'The Two Towers', author: 'J.R.R. Tolkien' },
		{ bookTitle: 'The Fellowship of the Ring', author: 'J.R.R. Tolkien' },
		{ bookTitle: 'The Children of Hurin', author: 'J.R.R. Tolkien' },
		{ bookTitle: 'The Adventures of Tom Bombadil', author: 'J.R.R. Tolkien' },
		{ bookTitle: 'The Tales of Beedle the Bard', author: 'J.R.R. Tolkien' }
	];
