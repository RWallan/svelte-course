...
<section class="author-section">
  ...
  <div class="author-container">
    <div class="author-text">
      <p>
        Richard Wallan is a seasoned expatriate with over seven years of
      ...
      <p>
        Richard’ practical advice is rooted in real-life experience, having
    ...
    <img src={authorPic} alt="Author Richard Wallan" />
  </div>
</section>
