<section class="chapter-preview default-marging">
  ...
  <div class="chapter-container">
    <ul>
      <li>
        <button
          ...
          aria-expanded="true"
          ><h3>Chapter 1: Navigating the Spanish Bureaucreacy</h3></button
        >
      </li>
    </ul>
    <div class="chapter-info">
      ...
      <p>
        ...
        and handler other legal formalities. Wheter you're planning a short-term
